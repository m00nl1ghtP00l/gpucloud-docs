---
title: End User Dashboards GPU and Server Metrics
description: End User Dashboards GPU and Server Metrics
tags:
  - Bare Metal Server as a Service
  - Metrics
  - Monitoring  
  - Dashboards
---

GPU and Server Metrics are available to end users from the end user portal (i.e. Developer Hub).
...
![View Metrics Menu](../metrics/img/view_metric.png)
...
![Base VM Metrics](../metrics/img/instance_met.png)
...
![GPU Metrics](../metrics/img/gpu_details.png)
...
![Metrics Duration](../metrics/img/metrics_duration.png)
