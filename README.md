...
The logo can be changed to a user-provided image (any type, incl. `*.png` and `*.svg`). Copy the logo and favicon files to the assets folder, then uncomment and update the following lines in your `mkdocs.yml` file. 
